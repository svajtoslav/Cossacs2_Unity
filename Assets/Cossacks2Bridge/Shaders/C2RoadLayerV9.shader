Shader "Cossacks2Bridge/RoadLayerV9"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Original road.xml color/alpha is kept from V8.
            // Unity adaptation: depth test must be enabled so roads do not render through hills.
