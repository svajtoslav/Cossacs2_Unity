Shader "Cossacks2Bridge/RoadLayerV10"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ZWrite Off
            ZTest LEqual
            // V10: pull road fragments slightly toward camera to avoid coplanar/bilinear terrain clipping,
            // while still letting real hills/mountains occlude roads.
            Offset -4, -4
            Cull Off

            // Original road.xml color/alpha is kept from V8/V9.
            // Unity adaptation: depth test remains enabled so roads do not render through hills; Offset fixes V9 sinking.
