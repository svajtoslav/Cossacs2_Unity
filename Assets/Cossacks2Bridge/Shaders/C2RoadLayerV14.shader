Shader "Cossacks2Bridge/RoadLayerV14"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ZWrite Off
            ZTest LEqual
            // V14: Offset remains, plus vertex shader clip-depth pull fixes remaining surface-depth clipping;
            // ZTest still lets real hills/mountains occlude roads.
            Offset -4, -4
            Cull Off
