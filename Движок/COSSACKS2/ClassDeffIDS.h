...
#define _lvCNode_			('LVA'+'DTX'+1)		// lvCNode
...
#define _lvCGroup_			('LVA'+'DTX'+7)		// lvCGroup
#define _lvCGroupsMAP_ST_	('LVA'+'DTX'+8)		// lvCGroupsMAP_ST
#define _vvMAP_ST_			('LVA'+'DTX'+9)		// vvMAP_ST
#define _vvBASE_			('LVA'+'DTX'+10)	// vvBASE
#define _vvTRIGER_			('LVA'+'DTX'+11)	// vvTRIGER
#define	_vvWORD_			('LVA'+'DTX'+12)	// vvWORD
#define	_vvINTEGER_			('LVA'+'DTX'+13)	// vvINTEGER
