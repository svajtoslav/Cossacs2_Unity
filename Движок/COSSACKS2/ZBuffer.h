...
void AddAnimation(int x,int y,int z,NewAnimation* ANM,int Frame,float Dir,DWORD Diffuse=0xFF808080,OneObject* OB=NULL,float Scale=1.0f,float fiDir=0.0f,float fiOrt=0.0f,DWORD Handle=0);
