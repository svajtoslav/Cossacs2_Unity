...
class DIALOGS_API CDEF_DATA : public BaseClass
{
public:
...
class DIALOGS_API CZM_ARS_LV : public ZoneExInfo
{
public:
	CZM_ARS_LV(){
		InfID	= _CZM_ARS_LV;
...
class DIALOGS_API CZM_DRS_LV : public ZoneExInfo
{
public:
	CZM_DRS_LV(){
		InfID	= _CZM_DRS_LV;
...
//***************************FOR CAMP**********************************
class DIALOGS_API CAMP_LV : public ZoneExInfo
{
public:
	CAMP_LV(){
		InfID = _CAMP_LV;
...
class DIALOGS_API	STRAT_ZONE : public ZoneExInfo
{
public:
	STRAT_ZONE() {
...
class DIALOGS_API	TOWER_ZONE : public ZoneExInfo
{
public:
	TOWER_ZONE() {
...
//grey [04.08.2004]
 ...
 //****************************FOR AI***********************************
class DIALOGS_API CAI_ZONE : public BaseClass
{
public:
...
class DIALOGS_API CAI_ZONE_Array : public ClassArray<CAI_ZONE>
{
public:
	virtual int GetExpansionRules(){			
		return 1;						//ƒобавить только сам класс, без наследников.
