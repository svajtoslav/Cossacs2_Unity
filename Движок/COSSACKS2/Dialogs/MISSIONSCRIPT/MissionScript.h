...
//Характеристики зон.
class	DIALOGS_API CBASE_ZONE : public BaseClass
{
public:
	DWORD	InfID;
...
class	DIALOGS_API	CZone00	: public CBASE_ZONE
{
public:
...
class	DIALOGS_API CZoneGiveQuest : public CBASE_ZONE
{
public:
...
class	DIALOGS_API	CBASE_RESS : public BaseClass
{
public:
	DWORD	InfID;
...
//Просто ресурс.
class DIALOGS_API	CMinerals : public CBASE_RESS
{
public:	
...
class DIALOGS_API	COpenZone : public CBASE_RESS //damn new
{
public:	
...
class DIALOGS_API	CGiveGroup : public CBASE_RESS //damn new
{
public:	
...
class DIALOGS_API	COffFogOfWar : public CBASE_RESS
{
public:	
...
//Отряд юнитов.
class DIALOGS_API	CTroops : public CBASE_RESS
{
public:
...
class	DIALOGS_API	CSCRIPT_TYPE : public BaseClass
{
public:
	DWORD	InfID;
...
class	DIALOGS_API	CKillEnemy00 : public CSCRIPT_TYPE
{
public:
...
class	DIALOGS_API CDirElement : public BaseClass
{
public:
	int		FromSecID;
	int		ToSecID;
...
class	DIALOGS_API CDirElement_Array : public ClassArray<CDirElement>
{
public:
...
class	DIALOGS_API CDirectonDataBase : public CSCRIPT_TYPE 
{
public:
...
class DIALOGS_API	CScript : public BaseClass
{
public:
	_str						ScriptName;
...
class DIALOGS_API	CScript_Array:public ClassArray<CScript>{
public:
	virtual int GetExpansionRules(){			
		return 1;						//Добавить только сам класс, без наследников.
	}
...
class DIALOGS_API	MISSION_SCRIPTS : public BaseClass
{
public:
