...
ITERATE_BOOL_REF(23,DrawEditorInterface,(),());
...
ITERATE_TBOOL_REF(52,OnUnitDamage,(OneObject* DamagedUnit,OneObject* Damager,int& Damage),(DamagedUnit,Damager,Damage));
