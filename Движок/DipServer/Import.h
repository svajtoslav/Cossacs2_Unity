...
#pragma pack(1)
typedef void GeneralObject;
typedef void Nation;
typedef void Visuals;
typedef void ObjectUpgrade;
typedef void ParameterUpgrade;
typedef void NewMonster;
typedef void OneObjectEx;
typedef void SelGroup;
typedef void FireInfo;
typedef void NewAnimation;
typedef void UnitActiveAbilityList;
typedef void Order1;
typedef void GOrder;
typedef void Coor3D;
typedef void Brigade;
