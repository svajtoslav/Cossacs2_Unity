...
/*****************************************************************************/
class Light : public TransformNode, public ILight
{
public:
	_inl					Light		();
	_inl					Light		( const Vector3D& dir );
	_inl					Light		( const Vector3D& pos, const Vector3D& dir );
...
public:
	...
	NODE(DirectionalLight, Light, DIRL);
}; // class DirectionalLight
...
public:
	...
	NODE(SpotLight, PointLight, SPOL);
}; // class SpotLight
