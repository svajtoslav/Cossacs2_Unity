...
/*	Desc:	Implementation of the ui manager
/*****************************************************************************/	
class WidgetManager : public Node, public IWidgetManager, public IDeviceClient
{
public:
					WidgetManager		();
					~WidgetManager		();
	...
	virtual void 	OnMouseMove			( int mX, int mY, DWORD keys );	
	virtual void 	OnMouseLButtonDown	( int mX, int mY );				
	virtual void 	OnMouseMButtonDown	( int mX, int mY );				
	virtual void 	OnMouseRButtonDown	( int mX, int mY );				
	virtual void 	OnMouseLButtonUp	( int mX, int mY );				
	virtual void 	OnMouseMButtonUp	( int mX, int mY );				
	virtual void 	OnMouseRButtonUp	( int mX, int mY );				
	virtual void 	OnMouseLButtonDblclk( int mX, int mY );				
	virtual void 	OnMouseRButtonDblclk( int mX, int mY );				
	virtual void 	OnMouseMButtonDblclk( int mX, int mY );				
	virtual void	OnKeyDown			( DWORD keyCode,  DWORD flags );	
	virtual void	OnChar				( DWORD charCode, DWORD flags );	
	virtual void	OnKeyUp				( DWORD keyCode,  DWORD flags );	
