...
_inl DWORD ColorValue::ARGB4444ToARGB8888( DWORD color )
{
	return  ((color & 0xF000) << 16) | ((color & 0x0F00) << 12) |
			((color & 0x00F0) << 8)  | ((color & 0x000F) << 4);
}

_inl int ColorValue::GetBytesPerPixel( ColorFormat cf )
{
	switch (cf)
	{
