...
public:
	...
	virtual	bool 	DrawSprite	( int gpID, int sprID, const Vector3D& pos, bool mirrored, DWORD color = 0 ) = 0;
	virtual	bool 	DrawWSprite	( int gpID, int sprID, const Vector3D& pos, bool mirrored, DWORD color = 0 ) = 0;
    ...
    virtual void    SetManagedCache     ( bool bManaged = true  ) = 0;
	...
	virtual	int		GetNFrames			( int gpID ) const = 0;
	...
	virtual	void 	FlushBatches		( bool bResetWorldTM = true ) = 0;
	...
	virtual	float	GetAvgAlpha			( int gpID, int sprID, const Triangle2D& tri ) = 0;
	virtual	BYTE	GetMaxAlpha			( int gpID, int sprID, const Triangle2D& tri ) = 0;
}; // ISpriteManager

extern ISpriteManager* ISM;
