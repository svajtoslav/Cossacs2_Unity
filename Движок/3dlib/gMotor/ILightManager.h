...
//
//void Light::AddActiveLight( Light* pLight )
//{
...
//} // Light::AddActiveLight
//
//void Light::ClearActiveLights()
//{
//    s_ActiveLights.clear();
//} // Light::ClearActiveLights
//
//void Light::MirrorActiveLights( const Plane& plane )
//{
//    int nLights = s_ActiveLights.size();
//    IRS->DisableLights();
//    for (int i = 0; i < nLights; i++)
//    {
//        Light* pLight = s_ActiveLights[i];
