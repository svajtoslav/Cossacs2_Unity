...
_inl const Vector3D& Sphere::GetCenter() const
{
	return m_Center;
}

_inl float Sphere::GetRadius() const
{
	return m_Radius;
}

_inl void Sphere::SetCenter( const Vector3D& center )
{
	m_Center = center;
}

_inl void Sphere::SetRadius( float radius )
{
	m_Radius = radius;
}
...
/*****************************************************************/
_inl bool Frustum::PtIn( const Vector3D& pt )
{	
