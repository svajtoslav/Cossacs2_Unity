...
public:
	...
	_inl bool				Intersect	( const Plane& p1, const Plane& p2, Vector3D& pt ) const;
	...
	_inl Matrix4D			ReflectionTM() const;
	//  flattens geometry onto the plane
	_inl Matrix4D			ProjectionTM( const Vector4D& dir ) const;
