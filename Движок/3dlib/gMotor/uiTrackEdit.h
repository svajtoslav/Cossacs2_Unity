...
public:
	...
	virtual	void				Render();
	void						SetTrack( FloatAnimationCurve* pCurve ) { m_pCurve = pCurve; }
	bool						OnMouseRButtonUp( int mX, int mY );
	
	NODE(FloatTrackEdit,KeyframeChart,TRED);
...
{
	const QuatAnimationCurve*	m_pCurve;
	...
	DeviceStateSet*				m_pLineShader;

public:
	QuatTrackEdit();

	virtual	void				Render();
	void						SetTrack( const QuatAnimationCurve* pCurve ) { 	m_pCurve = pCurve; }

	NODE(QuatTrackEdit,KeyframeChart,QTED);
...
public:
								ColorTrackEdit();
	virtual	void				Render();
	void						SetTrack( ColorAnimationCurve* pCurve ) { m_pCurve = pCurve; }
	...
	NODE(ColorTrackEdit,KeyframeChart,CTED);
