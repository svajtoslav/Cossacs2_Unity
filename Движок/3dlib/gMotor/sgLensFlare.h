...
/*****************************************************************************/
class LensFlareElement : public Node
{
public:
					LensFlareElement();
	...
	NODE(LensFlareElement,Node,LFEL);
...
class LensFlare : public Node
{
	...
	Node*				m_pScene;		//  scene which occludes the sun
...
public:
	...
	NODE(LensFlare,Node,LENS);

protected:
	DWORD				GetRandomFlareColor() const;
	BaseCamera*			CreateSunCamera();
