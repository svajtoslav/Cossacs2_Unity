...
/*****************************************************************************/
class Cursor : public HudNode, public InputDispatcher
{
public:
						Cursor();
	virtual				~Cursor();
...
public:
	...
	NODE(TexturedCursor, Cursor, TCUR);
...
public:
	...
	NODE(FramerateCursor,TexturedCursor,FCUR);
...
public:
	...
	NODE(HardwareCursor,TexturedCursor,HCUR);
