...
bool KeyframeChart::OnMouseLButtonDown( int mX, int mY )
{
	if (!IsActive() || IsInvisible()) return false;
	/*m_CurX = mX;
	m_CurY = mY;
	FromScreenSpace( m_CurX, m_CurY );
	*/
	return false;
} // KeyframeChart::OnMouseLButtonDown

bool KeyframeChart::OnMouseLButtonUp( int mX, int mY )
{
	return false;
} // KeyframeChart::OnMouseLButtonUp
...
bool KeyframeChart::OnMouseRButtonDown( int mX, int mY )
{
	return false;
} // KeyframeChart::OnMouseRButtonDown

bool KeyframeChart::OnMouseRButtonUp( int mX, int mY )
{
	return false;
} // KeyframeChart::OnMouseRButtonUp
...
bool FloatTrackEdit::OnMouseRButtonUp( int mX, int mY )
{
	...
	return false;
} // ColorTrackEdit::OnMouseLButtonUp
...
QuatTrackEdit::QuatTrackEdit()
{
	...
	m_pLineShader		= AddChild<DeviceStateSet>( "lines3D_blend" );
}
...
bool ColorTrackEdit::OnMouseRButtonUp( int mX, int mY )
{
	if (IsInvisible() || GetKeyState( VK_MENU ) < 0) return false;
	if (!m_pCurve || !InsideCurveArea( m_CurX, m_CurY ) || 
